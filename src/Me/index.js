  ...
  projects: [
    {
      ...
      description: '负责开发的创作者社区平台（Web + Mobile + Hybrid）。包括创作者作品申请、作品管理后台及创作者作品展示',
      highlights: [
    ...
    },
    {
      ...
      highlights: [
        ...
        '组件化、模块化开发组件且加入单元测试，降低线上出错概率的同时提高了开发效率',
    ...
    },
    {
      ...
      description: '负责开发的传统 PC 页面重构。应用新设计，重构豆瓣全站 Web 端条目，包括书影音、游戏、舞台剧等所有条目的长评页面，并加入长评赞赏新功能',
      highlights: [
    ...
    },
    {
      ...
      highlights: [
        ...
        '模块化、**组件化**思想，在传统 mobile 页面开发时，积极使用 `ES6 template literals` + `Fetch API` + `SCSS`，根据设计稿开发对应组件， 方便复用和快速生成页面，提高开发效率',
    ...
    },
    {
      ...
      title: 'Re-Resume',
      dates: '2017.08',
      description: '又一份排版良好，具有设计感的简历模板',
      highlights: [
        '原子化组件，简洁、简单，支持高度自定义',
        '技术栈： `React` + `styled-component` + `Typography` + `Webpack`  开发',
      ],
